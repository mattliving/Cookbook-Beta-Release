            ...
            public void onClick(View v) {
                ...
                if ((IngredientString != null) && (IngredientString.length() > 0)) {
                	if ((AmountString != null) && (AmountString.length() > 0)) {
                		...
                		TableRow rowIngredient = new TableRow(CookbookActivity.this);
                		EditText tIngredient = new EditText(CookbookActivity.this);
                		tIngredient.setHint("Ingredient");
                		tIngredient.setInputType(1);
                		tIngredient.setId(counterIngredient);
                		Button editButton = new Button(CookbookActivity.this);
                		...
                		//counterRow += 25;
                		TableRow rowAmount = new TableRow(CookbookActivity.this);
                		EditText tAmount = new EditText(CookbookActivity.this);
                		tAmount.setHint("Amount (weight, volume etc.)");
                		tAmount.setInputType(0);
                		tAmount.setId(counterAmount);
                		Button removeButton = new Button(CookbookActivity.this);
                		...
                		//counterRow += 25;
                		TableRow rowMeasurement = new TableRow(CookbookActivity.this);
                		Spinner tMeasurement = new Spinner(CookbookActivity.this);
                		tMeasurement.setPrompt("Measurement");
                		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(
                				CookbookActivity.this, R.array.WeightMeasurement, android.R.layout.simple_spinner_item);
                    	...
                    	IngredientString = null;
                		AmountString = null;
                    	new AlertDialog.Builder(CookbookActivity.this)
